...
export async function getHandymanProfilesForAdmin() {
  ...
  const rows = await db
    .select({
      ...
      serviceArea: handymanProfiles.serviceArea,
      externalGoogleReviewsUrl: handymanProfiles.externalGoogleReviewsUrl,
      externalFacebookReviewsUrl: handymanProfiles.externalFacebookReviewsUrl,
      externalWebsiteUrl: handymanProfiles.externalWebsiteUrl,
